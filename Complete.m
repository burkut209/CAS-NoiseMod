...
%       - Fig. 5: 2D comparison (Bob/Eve CAS vs Bob/Eve Baseline) at fixed alpha
%
%  Notes:
...
nbits_F4 = 1e5;                     % Bits for Fig. 4 style curves
nbits_F5 = 1e6;                     % Bits for Fig. 5 comparison plot

delta_dB_F4 = -10:1:40;             % delta(dB) sweep for Fig. 4
delta_F4    = 10.^(delta_dB_F4/10);

alpha_list_F4 = [1, 1.5, 3, 10];    % Fig. 4 alpha set

% Fig. 5 parameters (2D comparison plot)
delta_dB_F5 = -10:1:40;             % delta(dB) sweep for Fig. 5
delta_F5    = 10.^(delta_dB_F5/10);
alpha_F5    = 3.5;                  % Fixed alpha for Fig. 5
...
%% ================================================================
%  SECTION 3: FIG. 5 (2D Comparison: CAS-NoiseMod vs Baseline)
%            Bob and Eve for both schemes at fixed alpha
% ================================================================
fprintf('\n=== Fig. 5: 2D Comparison (CAS vs Baseline) at alpha = %.2f ===\n', alpha_F5);
...
%% Plot Fig. 5 (2D Comparison Plot)
figure('Color','white','Position',[150 120 900 650]);
hold on; grid on;
set(gca, 'YScale', 'log');

% Plot CAS-NoiseMod curves
...
% Save figures
print(gcf, 'Fig5_2D_CAS_vs_Baseline.eps', '-depsc', '-r300');
print(gcf, 'Fig5_2D_CAS_vs_Baseline.pdf', '-dpdf', '-r300');
print(gcf, 'Fig5_2D_CAS_vs_Baseline.png', '-dpng', '-r300');
